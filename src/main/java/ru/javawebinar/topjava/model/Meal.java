...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.BY_DATETIME, query = "SELECT meal FROM Meal meal WHERE meal.user.id=:userId AND meal.dateTime>=:startDateTime AND meal.dateTime<:endDateTime ORDER BY meal.dateTime DESC"),
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String BY_DATETIME = "Meal.getByDateTime";
